    ...
    return (
        <div className="relative" ref={ref}>
            <motion.button
                ...
                className="p-1 rounded-full cursor-pointer hover:bg-neutral-200/50 dark:hover:bg-zinc-800 text-zinc-200 hover:text-zinc-600 dark:text-zinc-200 dark:hover:text-zinc-200 transition-colors"
            >
