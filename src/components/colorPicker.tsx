    ...
    return (
        <div className="relative" ref={ref}>
            <motion.button
                ...
                className="p-1 rounded-full cursor-pointer hover:bg-neutral-200/50 dark:hover:bg-neutral-800 text-neutral-200 hover:text-neutral-600 dark:text-neutral-200 dark:hover:text-neutral-200 transition-colors"
            >
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, x: -10 }}
                        className="absolute bg-white dark:bg-neutral-900 right-0 top-full mt-3.5 p-3 border border-neutral-200 dark:border-neutral-800 rounded-xl shadow-lg min-w-[180px] z-50 origin-top-right"
                    >
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <ThemeSwitch variant="top-down" className="p-1 rounded-full cursor-pointer hover:bg-neutral-200/50 dark:hover:bg-neutral-800 text-neutral-400 hover:text-neutral-600 dark:text-neutral-400 dark:hover:text-neutral-200" />
                        </div>
