    ...
    return (
        <div className="relative" ref={ref}>
            <motion.button
                ...
                className="p-1 hover:bg-accent rounded-full text-foreground transition-colors opacity-50 cursor-pointer"
            >
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, x: -10 }}
                        className="absolute bg-white dark:bg-zinc-900 right-0 top-full mt-3.5 p-3 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-xl min-w-[180px] z-50 origin-top-right"
                    >
